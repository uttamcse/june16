...
/*	float mdc,mdm,mdp,mdpc;
	...
	void result()
	{
		...
		cout<<"------------------------------------------------------------------------------"<<endl;
		cout<<"Chemistry                       "<<tsc<<"    "<<tsc<<"  "<<tsc<<"    "<<tsc<<"   "<<cm<<endl;
		cout<<"Mathematics-II                         "<<tsc<<"    "<<tsc<<"    "<<tsc<<"   "<<mm<<endl;
		cout<<"Programming                "<<tsp<<"    "<<tsc<<"   "<<tsc<<" 	 "<<tsc<<"    "<<pm<<endl;
		cout<<"Profesional communication              "<<tsc<<"   "<<tsc<<"	 "<<tsc<<"    "<<pcm<<endl;
		cout<<"Workshop Practical                          	           "<<tsc<<"      "<<wp<<endl;
...
struct student s1={47,38,33,30,3338,33};
if(roll==1)
{
s1.result();	
}
